 ...
 */
@Controller
@RequestMapping(value = "/skuProperty")
public class SkuPropertyController {
    ...
    @Reference
    ISkuPropertyService propertyService;
    ...
    public String getProByCatalogId(@PathVariable("catalogId") Long catalogId, Map map){
        List<SkuProperty> propertyList = propertyService.getProByCatalogId(catalogId);
    ...
    @ResponseBody
    public JSONResultVo save(SkuProperty property){
